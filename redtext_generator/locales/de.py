...
STRINGS = {
    ...
    "phishing_templates": [
        ...
        {
            "id": "supply_chain",
            "name": "Lieferkettenangriff auf Softwareanbieter",
            "subject_lines": [
                "Dringend: Sicherheitspatch für {software} verfügbar — Installation bis {deadline} erforderlich",
                "[{software}] Kritisches Update erforderlich — Handlungsbedarf",
                "Pflichtupdate: Sicherheitsaktualisierung des Anbieters {software} — Ref.: {reference}",
                "{software} Integrations-Update — Ihre Autorisierung wird benötigt",
            ],
            "body": "Hallo {first_name},\n\nwir kontaktieren Sie bezüglich eines kritischen Sicherheitsupdates für {software}, das sofortiges Handeln aller autorisierten Benutzer erfordert.\n\nIm Rahmen unserer laufenden Partnerschaft mit {company} haben wir eine Schwachstelle in der aktuellen Bereitstellung identifiziert, die bis zum {deadline} behoben werden muss.\n\nBitte laden Sie das Update über den folgenden sicheren Link herunter und installieren Sie es:\n\n{phishing_link}\n\nDieses Update wurde von Ihrer IT-Abteilung geprüft und freigegeben. Sollten Sie Schwierigkeiten bei der Installation haben, wenden Sie sich an Ihren {software}-Kundenbetreuer.\n\n{signature}",
        },
        {
            "id": "credential_breach",
            "name": "Benachrichtigung über Zugangsdatenleck",
            "subject_lines": [
                "SICHERHEITSWARNUNG: Ihre {company}-Zugangsdaten in einem Datenleck gefunden",
                "Handlungsbedarf: Passwort-Zurücksetzung nach Datenleck eines Drittanbieters",
                "Dringend: Ihr {software}-Konto könnte kompromittiert sein",
                "[Sicherheitsteam] Pflicht-Passwortänderung — Datenleck erkannt",
            ],
            "body": "Sehr geehrte/r {first_name},\n\nunsere Sicherheitsüberwachung hat festgestellt, dass mit Ihrem {company}-Konto verknüpfte Zugangsdaten in einem Datenleck eines Drittanbieters gefunden wurden. Dies ist KEINE Kompromittierung der {company}-Systeme, aber Ihre Zugangsdaten könnten durch einen kompromittierten externen Dienst offengelegt worden sein.\n\nZum Schutz Ihres Kontos müssen Sie Ihr Passwort umgehend zurücksetzen:\n\n{phishing_link}\n\nWenn Sie Ihr Passwort nicht bis zum {deadline} zurücksetzen, wird Ihr Konto vorsorglich vorübergehend gesperrt.\n\nZu Ihrer Information: Die kompromittierten Daten wurden am {date} identifiziert und umfassen E-Mail-Adressen sowie gehashte Passwörter. Wir empfehlen Ihnen dringend, nach der Passwort-Zurücksetzung die Multi-Faktor-Authentifizierung zu aktivieren.\n\n{signature}",
        },
    ],
    ...
    "vishing_scripts": [
        ...
        },
        {
            ...
            "name": "Passwort-Zurücksetzung / Privilegien-Eskalation",
            "opening": "[ANRUFER]: Guten Tag, hier spricht {caller_name} aus der Abteilung Identitäts- und Zugriffsmanagement bei {company}.\nIch rufe an, weil Ihr Konto für eine verpflichtende Berechtigungsüberprüfung markiert wurde.\nSpreche ich mit {target_name} aus der Abteilung {department}?",
            "escalation": "[ANRUFER]: Gut. Folgende Situation — bei unserer vierteljährlichen Zugriffsüberprüfung\nhaben wir festgestellt, dass Ihr Konto über erhöhte Berechtigungen verfügt, die rezertifiziert werden müssen.\nIch habe Ihr Ticket hier — Nummer {ticket_number}, erstellt von {manager_name}.\nUm die Rezertifizierung abzuschließen, muss ich Sie bitten, Ihre aktuelle Zugriffsstufe zu bestätigen,\nund dann führe ich Sie durch den Zurücksetzungsprozess.\nKönnen Sie mir Ihre aktuelle Rolle und die Administrationsgruppen nennen, denen Sie angehören?",
            "objective": "ZIEL: Das Ziel dazu bringen:\n  - Zugriffsstufe und Zugehörigkeit zu Administrationsgruppen preiszugeben\n  - Zu einem gefälschten IAM-Portal für die «Rezertifizierung» zu navigieren\n  - Aktuelle Zugangsdaten zur «Verifizierung vor der Zurücksetzung» einzugeben\n  - Eine gefälschte MFA-Anfrage zu genehmigen (Push-Benachrichtigungsangriff)\n  - Zugangsdaten von Dienstkonten preiszugeben, die sie verwalten",
            "red_flags_to_avoid": "GLAUBWÜRDIGKEIT BEWAHREN:\n  \u2717 Behaupten Sie nicht, dass das Konto kompromittiert ist — sprechen Sie von einer Routineüberprüfung\n  \u2717 Fragen Sie nicht direkt nach Passwörtern — nutzen Sie das «Rezertifizierungsportal»\n  \u2717 Überstürzen Sie den Prozess nicht — IAM-Teams arbeiten methodisch\n  \u2717 Rufen Sie nicht an, ohne die tatsächlichen Verwaltungstools des Ziels zu kennen\n  \u2713 Kennen Sie die echten Namen der Administrationsgruppen (aus OSINT, LinkedIn, Stellenanzeigen)\n  \u2713 Verweisen Sie auf echte IAM-Tools des Unternehmens (Azure AD, Okta, CyberArk)\n  \u2713 Verwenden Sie eine gefälschte Anrufer-ID der IAM-/Identitätsabteilung\n  \u2713 Seien Sie bereit, den Rezertifizierungsprozess im Detail zu erklären",
        },
        {
            "id": "service_account_audit",
            "name": "Sicherheitsaudit der Dienstkonten",
            "opening": "[ANRUFER]: Guten {time_of_day}, hier spricht {caller_name} vom Security Operations Center bei {company}.\nIch kontaktiere Sie bezüglich des compliance-vorgeschriebenen Dienstkonten-Audits.\nIch muss mit der Person sprechen, die die {software}-Dienstkonten in der Abteilung {department} verwaltet.",
            "escalation": "[ANRUFER]: Gut, im Rahmen unserer SOC2/ISO-27001-Compliance-Anforderungen\nprüfen wir alle Dienstkonten der Organisation.\n{manager_name} aus der Abteilung {department} wurde vor zwei Wochen über dieses Audit informiert.\nIch muss die Dienstkonten Ihrer {software}-Implementierung überprüfen —\nkonkret die Kontonamen, den Rotationszeitplan und wer Zugriff hat.\nKönnen Sie diese Informationen zusammenstellen? Außerdem muss ich Sie bitten,\ndie Gültigkeit der aktuellen Zugangsdaten über unser Audit-Portal zu testen.",
            "objective": "ZIEL: Das Ziel dazu bringen:\n  - Namen und Konfigurationen der Dienstkonten offenzulegen\n  - Den Passwort-Rotationszeitplan und das Datum der letzten Änderung preiszugeben\n  - Zugangsdaten über ein vom Angreifer kontrolliertes «Audit-Portal» zu testen\n  - API-Schlüssel oder Tokens der Dienstkonten weiterzugeben\n  - Temporären Zugriff auf die Dienstkonten-Verwaltungskonsole zu gewähren",
            "red_flags_to_avoid": "GLAUBWÜRDIGKEIT BEWAHREN:\n  \u2717 Geben Sie sich nicht ohne Vorbereitung als externer Prüfer aus\n  \u2717 Fordern Sie nicht alle Dienstkonten auf einmal an — beginnen Sie mit einem System\n  \u2717 Verwenden Sie keine Compliance-Fachbegriffe, die Sie bei Nachfrage nicht erklären können\n  \u2717 Vergessen Sie nicht die Referenz auf einen Verantwortlichen, der das Audit genehmigt hat\n  \u2713 Recherchieren Sie die tatsächlichen Compliance-Rahmenwerke des Unternehmens\n  \u2713 Kennen Sie die Namenskonventionen der Dienstkonten (Fehlermeldungen, Stellenanzeigen)\n  \u2713 Verweisen Sie auf echte Audit-Fristen (SOC2 Typ II ist jährlich)\n  \u2713 Bieten Sie an, die Audit-Anfrage per offiziell aussehender E-Mail zur Verifizierung zu senden",
        },
    ],
    ...
    "physical_pretexts": [
        ...
        },
        {
            ...
            "name": "Kopierer-/Druckertechniker",
            "appearance": "Professionelle Kleidung mit Anbieter-Polo, Werkzeugkoffer auf Rollen, Laptoptasche, Ausweis mit Druckeranbieter-Logo",
            "props": [
                "Polo in Anbieterfarben (Canon, Ricoh, Xerox oder HP)",
                "Werkzeugkoffer auf Rollen mit Grundwerkzeug und Tonerpatronen",
                "Laptop für «Diagnose und Firmware-Updates»",
                "Gedruckter Arbeitsauftrag mit Verweis auf Druckermodell und Stockwerk",
                "Ausweis mit Logo und Foto der Anbieterfirma",
            ],
            "script": "Guten Tag, ich bin {name} von {printer_vendor}. Wir haben eine automatische Meldung erhalten,\ndass die {printer_model} im {floor}. Stockwerk gewartet und ein Firmware-Update benötigt.\nIch benötige direkten Zugang zum Drucker und muss meinen Laptop für das Firmware-Update\nanschließen. Außerdem muss ich die Netzwerkverbindung am Druckserver überprüfen.\nDas sollte etwa 45 Minuten dauern. Möglicherweise muss ich auch die Drucker\nin anderen Stockwerken überprüfen — unser System hat mehrere für dasselbe Update markiert.",
            "target_areas": ["Büroetagen mit Netzwerkdruckern", "Druckräume und Reprografie-Center", "Netzwerkräume mit Druckserver-Anschlüssen", "Etagen der Geschäftsleitung (hochwertige Ziele)", "Mehrere Stockwerke für «Sammelwartung»"],
            "objectives": [
                "Ein Netzwerk-Implantat über den Ethernet-Anschluss des Druckers installieren",
                "Zugang zu mehreren Stockwerken unter dem Vorwand einer «Sammelwartung» erhalten",
                "Zugangsdaten vom Druckserver oder zwischengespeicherten Druckaufträgen sammeln",
                "Ein Abhörgerät an Netzwerkanschlüssen in der Nähe von Druckern installieren",
                "Die Büroaufteilung kartieren und hochwertige Arbeitsstationen beim Rundgang identifizieren",
            ],
        },
        {
            "id": "it_asset_inventory",
            "name": "IT-Asset-Inventarisierungs-Spezialist",
            "appearance": "Professionelle Kleidung, Klemmbrett mit Asset-Erfassungsbogen, Barcode-Scanner, Laptop, IT-Abteilungsausweis am Schlüsselband",
            "props": [
                "Klemmbrett mit gedrucktem Asset-Inventarbogen mit bestehenden Einträgen",
                "USB-Barcode-Scanner zum «Scannen von Asset-Etiketten»",
                "Laptop mit geöffneter «Asset-Management-Software»",
                "Kamera zum «Fotografieren von Asset-Etiketten und Seriennummern»",
                "IT-Abteilungsausweis (generisch oder gefälscht)",
            ],
            "script": "Guten Tag, ich bin {name} vom IT-Asset-Management. Wir führen die jährliche\nHardware-Inventur für {company} durch — jede Workstation, jeder Monitor und jedes Netzwerkgerät\nmuss überprüft werden. Ich muss das Asset-Etikett jeder Maschine physisch scannen\nund verifizieren, dass die Seriennummer mit unseren Aufzeichnungen übereinstimmt. Ich werde heute\nSchreibtisch für Schreibtisch im {floor}. Stockwerk durchgehen. Die Gebäudeverwaltung und Ihr\nAbteilungsleiter wurden letzte Woche informiert. Ich versuche, schnell zu sein und niemanden zu stören.",
            "target_areas": ["Jeder Schreibtisch und jede Workstation im Zielstockwerk", "Serverräume und Netzwerkschränke", "Besprechungsräume mit AV-Ausstattung", "Lagerräume mit Ersatzhardware", "Büros der Geschäftsleitung"],
            "objectives": [
                "Längeren, systematischen Zugang zu jeder Workstation im Gebäude erhalten",
                "Bildschirme, Haftnotizen und Whiteboards fotografieren, um Zugangsdaten zu sammeln",
                "USB-Keylogger oder Netzwerk-Implantate unter dem Vorwand des «Asset-Scannens» installieren",
                "Die gesamte physische Netzwerktopologie und Büroaufteilung kartieren",
                "Unverschlüsselten Netzwerkverkehr oder unsichere Protokolle identifizieren",
            ],
        },
    ],
