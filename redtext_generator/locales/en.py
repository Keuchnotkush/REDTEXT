"""English locale strings for REDTEXT (default / source of truth)."""
...
STRINGS = {
    ...
    "generator": {
        ...
        "billing_department": "Billing Department, {company}",
        "attachment_prefix": "Attachment",
        "deadlines": ["24 hours", "end of business today", "4:00 PM today", "Friday"],
        "deadlines_vishing": ["end of day", "tomorrow", "by noon"],
        "deadlines_quishing": ["24 hours", "end of business today", "Friday at 5:00 PM"],
        "document_types": ["document", "spreadsheet", "report", "invoice"],
        "vishing_issues": [
            "unusual login activity",
            "a failed security scan",
            "unpatched software vulnerabilities",
            "anomalous network traffic",
        ],
        "vishing_actions": ["wire transfer", "data transfer", "password reset"],
